...
`;
  ...
  return React.createElement('div', { ref: mountRef, className: `liquid-ether-container ${className || ''}`, style });
}


window.LiquidEtherReact = {
  mount(mountNode, props) {
    const element = React.createElement(LiquidEther, props);
    ...
    return () => ReactDOM.unmountComponentAtNode(mountNode);
  }
};
